                    ...
                    <div className="flex flex-wrap -m-4">
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <p className="leading-relaxed">First and foremost, the variety of products available at Maruthi Super Market is outstanding. From premium brands to more affordable options, there's something for every preference and budget. I particularly liked the diverse range of products and brands they offer, which enables customers to compare and select the most suitable options for their requirements.</p>
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <p className="leading-relaxed">I recently visited Maruthi Super Market to do some shopping, and I am absolutely thrilled with my experience. From the moment I walked in, I was greeted by friendly and knowledgeable staff who helped me navigate through their wide selection of products.</p>
                                <span className="inline-block h-1 w-10 rounded bg-green-500 mt-6 mb-4" />
                        ...
                        <div className="lg:w-1/3 lg:mb-0 p-4">
                            <div className="h-full text-center">
                                ...
                                <p className="leading-relaxed">I recently had the pleasure of shopping at Maruthi Super Market, and I must say, it was a fantastic experience from start to finish. From their extensive range of products to their exceptional customer service, everything about my visit exceeded my expectations.</p>
                                <span className="inline-block h-1 w-10 rounded bg-green-500 mt-6 mb-4" />
